	...
	<main>
			...
			<div class="container container-nav">
				...
				<div class="ent-menu-responsivo">
					...
					<ul>
						...
						<li>
							<a class="menu-link" href="#setores" title="Aplicações">Setores Atendidos</a>
						</li>
						<li>
		...
		<section class="setores" id="setores">
			<div class="container">
				<div class="row">
					<div class="w-12">
						<h2><strong>Setores atendidos</strong> e aplicações</h2>
						<p class="dark">A HPP oferece soluções de alta pressão versáteis e eficientes para os principais setores da indústria.</p>
						...
						<div class="row">
							...
							<div class="w-3">
								<div class="card-icons">
									<img src="images/ic-4-1.webp" alt="Indústria Alimentícia" title="Indústria Alimentícia">
									<h3>Indústria Alimentícia</h3>
								</div>
							</div>
							<div class="w-3">
								<div class="card-icons color-2">
									<img src="images/ic-4-2.webp" alt="Siderurgia" title="Siderurgia">
									<h3>Siderurgia</h3>
								</div>
							</div>
							<div class="w-3">
								<div class="card-icons">
									<img src="images/ic-4-3.webp" alt="Mineração" title="Mineração">
									<h3>Mineração</h3>
								</div>
							</div>
							<div class="w-3">
								<div class="card-icons color-2">
									<img src="images/ic-4-4.webp" alt="Oil & Gas" title="Oil & Gas">
									<h3>Oil & Gas</h3>
								</div>
							</div>
							<div class="w-3">
								<div class="card-icons">
									<img src="images/ic-4-5.webp" alt="Limpeza de Redes Elétricas" title="Limpeza de Redes Elétricas">
									<h3>Limpeza de Redes Elétricas</h3>
								</div>
							</div>
							<div class="w-3">
								<div class="card-icons color-2">
									<img src="images/ic-4-6.webp" alt="Limpeza Urbana" title="Limpeza Urbana">
			...
			<div class="container">
				<div class="row">
					<div class="w-12">
						...
						<div class="row row-bombas">
							<div class="w-6 bomba-card">
								<img src="images/produtos/2-1.webp" alt="Bombas até 300 bar" title="Bombas até 300 bar">
								<h3>Bombas <strong>até 300 bar</strong></h3>
							</div>
							<div class="w-6 bomba-card">
								<img src="images/produtos/2-1.webp" alt="Bombas até 600 bar" title="Bombas até 600 bar">
								<h3>Bombas <strong>até 600 bar</strong></h3>
							</div>
						</div>
					</div>
				</div>
